...
(() => {
  ...
  window.QLCAD_CLOUD_SESSION=Object.freeze({active,failure,ready:()=>active(),showError:message=>{if(!active())return;const target=document.querySelector('#glossaryMessage, #historyMessage');if(target)target.textContent=message;}});
